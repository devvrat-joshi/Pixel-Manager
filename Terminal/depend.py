...
def option(stdscr,h,w):
    ...
    stdscr.addstr(h-1,2*w//5-1," "*(3*w//5+1),curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5-1," c ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+2,"Copy",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+6," m ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+9,"Move",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+13," k ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+16,"File",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+20," g ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+23,"Folder",curses.color_pair(13))
