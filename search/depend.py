...
def option(stdscr,h,w):
    ...
    stdscr.addstr(h-1,2*w//5+x," "*(3*w//5+1),curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x," c ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x+3,"Copy",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+x+7," m ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x+10,"Move",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+x+14," k ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x+17,"File",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+x+21," g ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x+24,"Folder",curses.color_pair(13))
    stdscr.addstr(h-1,2*w//5+x+30," d ",curses.color_pair(15))
    stdscr.addstr(h-1,2*w//5+x+33,"Delete",curses.color_pair(13))
